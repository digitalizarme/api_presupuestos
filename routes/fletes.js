...
module.exports = (app, router) => {
    ...
    router.get('/fletes/:id', async function (context) {
        ...
        context.body = await Fletes.findOne({where: {
                id
            }})
    ...
    router.put('/fletes', async function (context) {
        ...
        try
        {
            await Fletes.update(datos, {where: {
                    id
                }});
            context.body = datos;
        } catch (error) {
    ...
    router.delete('/fletes', async function (context) {
        try {
            ...
            context.body = await Fletes.destroy({where: {
                    id
                }});
        } catch (error) {
            throw Error(traduceErrores(error))
