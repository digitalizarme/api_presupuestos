...
module.exports = (app, router) => {
    ...
    router
        .get('/mediosPagos', async function (context) {
    ...
    router.put('/mediosPagos', async function (context) {
        ...
        try
        {
            await MediosPagos.update(datos, {where: {
                    id
                }});
            context.body = datos;
        } catch (error) {
    ...
    router.delete('/mediosPagos', async function (context) {
        try {
            ...
            context.body = await MediosPagos.destroy({where: {
                    id
                }});
        } catch (error) {
            throw Error(traduceErrores(error))
    ...
    router.get('/mediosPagos/:id', async function (context) {
        ...
        context.body = await MediosPagos.findOne({where: {
                id
            }});
