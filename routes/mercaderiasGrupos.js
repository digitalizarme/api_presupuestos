...
module.exports = (app, router) => {
    ...
    router
        .get('/mercaderiasGrupos', async function (context) {
    ...
    router.get('/mercaderiasGrupos/:id', async function (context) {
        ...
        context.body = await MercaderiasGrupos.findOne({where: {
                id
            }})
    ...
    router.put('/mercaderiasGrupos', async function (context) {
        ...
        try
        {
            await MercaderiasGrupos.update(datos, {where: {
                    id
                }});
            context.body = datos;
        } catch (error) {
    ...
    router.delete('/mercaderiasGrupos', async function (context) {
        try {
            ...
            context.body = await MercaderiasGrupos.destroy({where: {
                    id
                }});
        } catch (error) {
            throw Error(traduceErrores(error))
