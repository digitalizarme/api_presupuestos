...
module.exports = (app, router) => {
    ...
    router.get('/seguros/:id', async function (context) {
        ...
        context.body = await Seguros.findOne({where: {
                id
            }})
    ...
    router.put('/seguros', async function (context) {
        ...
        try
        {
            await Seguros.update(datos, {where: {
                    id
                }});
            context.body = datos;
        } catch (error) {
    ...
    router.delete('/seguros', async function (context) {
        try {
            ...
            context.body = await Seguros.destroy({where: {
                    id
                }});
        } catch (error) {
            throw Error(traduceErrores(error))
