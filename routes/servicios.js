...
module.exports = (app, router) => {
    ...
    router
        .get('/servicios', async function (context) {
    ...
    router.get('/servicios/:id', async function (context) {
        ...
        context.body = await Servicios.findOne({where: {
                id
            }})
    ...
    router.post('/servicios', async function (context) {
        ...
        try
        {
            if (isNaN(datos.n_id_grupo)) {
                await ServiciosGrupos
                    .create({c_descripcion: datos.n_id_grupo, b_activo: true})
                    .then(model => (datos.n_id_grupo = model.id))
            }
            await Servicios
                .create(datos)
    ...
    router.put('/servicios', async function (context) {
        ...
        try
        {
            ...
            await Servicios.update(datos, {where: {
                    id
                }});
            context.body = datos;
        } catch (error) {
    ...
    router.delete('/servicios', async function (context) {
        try {
            ...
            context.body = await Servicios.destroy({where: {
                    id
                }});
        } catch (error) {
            throw Error(traduceErrores(error))
